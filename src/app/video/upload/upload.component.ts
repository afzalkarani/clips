    ...
    forkJoin([
    ...
    ).subscribe(
      {
        next: async (urls) => {
          ...
          this.alertMsg = 'Success! Your Clip is ready to be share to the world'
        ...
        error: (error) => {
          ...
          this.alertColor = 'red'
          this.alertMsg = `Upload failed. Please try again later. Error Details ${error}`
